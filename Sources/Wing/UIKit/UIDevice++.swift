...
public extension UIDevice {
    var storage: Int64 {
        get { return (FileManager.default.fileAttribute(.systemSize, of: NSHomeDirectory()) as? NSNumber)?.int64Value ?? 0 }
    }

    var usedStorage: Int64 {
        get { return self.storage - self.availableStorage }
    }

    var availableStorage: Int64 {
        get { return (FileManager.default.fileAttribute(.systemFreeSize, of: NSHomeDirectory()) as? NSNumber)?.int64Value ?? 0 }
    }
    ...
    var freeMemory: UInt64 {
        get { return ProcessInfo.processInfo.physicalMemory }
    }
    var usageMemory: UInt64 {
        get { return ProcessInfo.processInfo.physicalMemory }
    }
...
public extension UIDevice {
    var uuid: String {
        get { return self.identifierForVendor?.uuidString ?? "" }
    }
